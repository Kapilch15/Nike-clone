...
const Hero = () => {
  ...
  return (
   <section id="home" className="w-full gap-10 max-container flex xl:flex-row justify-center min-h-screen">
    <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
      ...
      <br />
      <span className="text-coral-red inline-block mt-3">NikeRun</span> Shoes
      </h1>
