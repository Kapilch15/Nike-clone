...
const Hero = () => {
  ...
  return (
   <section id="home" className="w-full gap-10 max-container flex xl:flex-row justify-center min-h-screen py-3">
    ...
    <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-10 bg-primary">
      <img src={bigShoe1} alt="shoes" width={610} height={500} className="object-contain relative z-10"/>
